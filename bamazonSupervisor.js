...
function viewProductsByDepartment(){
    connection.query(
        "SELECT departments.department_id, departments.departments_name, departments.over_head_cost, products.product_sales, products.product_sales - departments.over_head_cost AS total_profit FROM departments RIGHT JOIN products ON departments.departments_name = products.department_name",
